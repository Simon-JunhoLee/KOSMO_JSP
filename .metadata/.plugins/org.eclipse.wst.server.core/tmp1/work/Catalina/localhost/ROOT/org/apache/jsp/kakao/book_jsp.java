 ...
 * Generated at: 2024-04-29 07:06:49 UTC
...
public final class book_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	        <form class=\"input-group\" name=\"frm\" action=\"\">\r\n");
      out.write("	            <input class=\"form-control\" type=\"text\" name=\"query\" value=\"java\" placeholder=\"도서명\">\r\n");
      ...
      out.write("				<div class=\"card mx-1 my-3\">\r\n");
      out.write("					<div class=\"card-body\">\r\n");
      out.write("						<img src=\"{{check thumbnail}}\" width=\"100%\">\r\n");
      out.write("					</div>\r\n");
      ...
      out.write("	    }else {\r\n");
      out.write("	        return \"http://via.placeholder.com/124x180\";\r\n");
      out.write("	    }\r\n");
      out.write("	});\r\n");
      out.write("\r\n");
      out.write("	let query = $('[name=\"query\"]').val();\r\n");
      out.write("	let page = 1;\r\n");
      out.write("	let size = 6;\r\n");
      out.write("	getData();\r\n");
      out.write("	// 다음 버튼을 클릭한 경우 (페이징 처리)\r\n");
      out.write("    $(\"#next\").on(\"click\", function(){\r\n");
      out.write("        page++;\r\n");
      out.write("        getData();\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    // 이전 버튼을 클릭한 경우 (페이징 처리)\r\n");
      ...
      out.write("		query = $('[name=\"query\"]').val();\r\n");
      out.write("		if(query==''){\r\n");
      ...
      out.write("			data:{query:query, size:size, page:page},\r\n");
      out.write("			success:function(data){\r\n");
      out.write("				console.log(data);\r\n");
      out.write("				const temp = Handlebars.compile($('#temp_book').html());\r\n");
      out.write("				$('#div_book').html(temp(data));\r\n");
      out.write("				const last = Math.ceil(data.meta.pageable_count/size);\r\n");
