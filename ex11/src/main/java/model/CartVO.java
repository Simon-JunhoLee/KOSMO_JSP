...
public class CartVO extends GoodsVO{
	...
	public CartVO(int ucnt, int fcnt, String gid, String title, int price, String brand, String image, String regDate) {
		super(ucnt, fcnt, gid, title, price, brand, image, regDate);
		// TODO Auto-generated constructor stub
	}
