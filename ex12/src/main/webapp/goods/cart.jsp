...
<div id="page-cart">
	...
	<div class="text-center">
		...
		<a href="/" class="btn btn-secondary" id="continue">쇼핑 계속하기</a>
	</div>
</div>
...
<script id="temp_cart" type="x-handlebars-template">
	...
	<table class="table table-hover">
		...
		<tr class="goods-row" gid="{{gid}}">
			<td class="text-center"><input class="form-check-input chk" goods="{{toString @this}}" type="checkbox"></td>
